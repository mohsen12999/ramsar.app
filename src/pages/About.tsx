    ...
    <Layout>
        <div className="hero bg-base-200 main">
            <div className="flex-col hero-content lg:flex-row-reverse">
                <img
                    src={"/img/national-park.png"}
                    alt="رامسر اپ"
                    className="max-w-sm rounded-lg shadow-2xl"
                />
                <div>
                    <h1 className="mb-5 text-5xl font-bold vazir-font">
                        درباره ما
                    </h1>
                    <p className="mb-5 vazir-font">
                        من محسن شعبانیان سازنده این اپ هستم. رامسر اپ یک پروژه
                        شخصی هست و که بدون هیچ چشم‌داشت مالی برای کمک به شناخت و
                        پیدا کردن امکانات در سطح شهر با امبد کمک خود همشهریان و
                        علاقه‌مندان ساخته شده.
                    </p>
                    <p className="mb-5 vazir-font">
                        طرح ساخت این نرم افزارهای مشابه و حتی نمونه‌های بهتر و
                        با امکانات بیشتر سال‌هاست با بدقولی و پیمان شکنی‌های
                        مسئولین شهری به کناری افتاده‌اند. این نرم‌افزار ساده
                        آخرین تلاشم هست تا به صورت مستقل و با کمک همشهریان و
                        علاقه‌مندان این پروژه را به سرانجام برسانیم.
                    </p>
                    <p className="mb-5 vazir-font">
                        به شدت منتظر پیشنهادات، انتقادات و معرفی مکان جدید از
                        طرف شما هستیم.
                    </p>
